...
function reduceChains (chains, cache) {
  ...
  const unflattenedDefaultOptions = reduceOptions(chains.defaultChain, null, pluginsAndPresets, dependencies, sources, fixedSourceHashes)
  ...
  for (const pair of chains.envChains) {
    ...
    unflattenedEnvOptions.set(envName, reduceOptions(chain, envName, pluginsAndPresets, dependencies, sources, fixedSourceHashes))
  }
